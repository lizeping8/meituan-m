<template>
    <div class="cartDetails">
        ...
        <!-- 结算 -->
        <van-submit-bar v-if="isDelete" class="submit-all" :price="allPrice*100" button-text="提交订单" @submit="onSubmit" button-color="#ffc400" >
...
import emitter  from "../../../components/js/eventbus";
...
export default {
    ...
    setup (props) {
        ...
        return {...toRefs(data),store,onChange,onSubmit,choseAll,groupChange,allPrice,deleteClick}
    }
}
</script>
