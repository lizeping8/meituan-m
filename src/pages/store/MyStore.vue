<template>
      ...
      <div class="foodClassify">
        ...
        <div class="classify">
            <van-tabs color="#ffc400">
                <van-tab v-for="(i,index) in storeData" :key="index" :title="i.name">
    ...
    <van-action-bar>
        ...
        <van-action-bar-icon icon="cart-o" text="购物车" :badge="store.state.cartList.length" @click="clickBuy" />
...
export default {
    ...
    setup () {
      ...
      const router = useRouter();
        ...
        return{...toRefs(data),service,handleAddCart,store,clickBuy,toCart}
    }
}
</script>
